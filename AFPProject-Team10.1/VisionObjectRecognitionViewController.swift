...
class VisionObjectRecognitionViewController: ViewController {
    ...
    func drawVisionRequestResults(_ results: [Any]) {
        ...
        super.myTimer = Double(0.4 - timer1)
        super.flag = localflag
...
//        textLayer.string = formattedString
        ...
        // rotate the layer into screen orientation and scale and mirror  CGFloat(.pi / 2.0)
    ...
    func createRoundedRectLayerWithBounds(_ bounds: CGRect) -> CALayer {
        ...
        shapeLayer.backgroundColor = CGColor(colorSpace: CGColorSpaceCreateDeviceRGB(), components: [1, 0, 0, 0.4])
